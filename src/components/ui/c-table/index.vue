<template>
    <el-table header-cell-class-name="table-header-cell-class-name" ref="tableRef" :data="tableData" :row-key="rowKey"
        v-loading="loading" v-bind="$attrs" @selection-change="handleSelectionChange">
